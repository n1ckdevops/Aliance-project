...
<body>
  ...
  <header class="section about header-bg">
    ...
    <div class="container container-about">
      ...
      <a href="index.php" class="small-nav-main">Главная &mdash;</a>&nbsp;
      <a href="contracts.php" class="small-nav-main">Контрактное производство &mdash;</a>
      <a href="" class="small-nav-about"><?= $page_title ?></a>
    </div>
  </header>